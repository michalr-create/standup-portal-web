...
export default function HeartButton({ type, slug, onToggle, size = 20, inactiveColor }: Props) {
  ...
  return (
    <button
      ...
      style={{
        ...
        border: "none",
        cursor: "pointer",
        padding: size < 18 ? "3px" : "6px",
        color: active ? "var(--coral)" : (inactiveColor ?? "var(--paper-mute)"),
