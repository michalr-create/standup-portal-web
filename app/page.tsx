...
export const revalidate = 300; // odświeżaj dane co 5 minut
    ...
    <main className="max-w-6xl mx-auto px-4 py-10">
      <header className="mb-10">
        ...
        <p className="text-gray-400">
          Nowości z polskiej sceny stand-upowej
        </p>
      </header>

      {items.length === 0 ? (
        <div className="text-gray-400 text-center py-20">
          Brak zatwierdzonych treści. Wróć za chwilę.
        </div>
      ) : (
      ...
      <footer className="mt-20 pt-10 border-t border-neutral-800 text-center text-xs text-gray-500">
        Agregator treści. Wszystkie prawa do materiałów należą do ich twórców.
      </footer>
    </main>
  );
}
